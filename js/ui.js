...
function setDifficulty(level) {
  ...
  console.log("[setDifficulty] IA Difficulty impostata a:", window.AI_DIFFICULTY);
  updateDifficultyBadges();
...
function updateDifficultyBadges() {
  ...
  let emoji = "🟡"; // default intermediate
  
  if (window.AI_DIFFICULTY === "hard") {
    emoji = "🔴"; // hard = rosso
  } else if (window.AI_DIFFICULTY === "expert") {
    emoji = "⭐"; // expert = stella
  }
